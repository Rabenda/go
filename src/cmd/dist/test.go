...
func (t *tester) extLink() bool {
	...
	case "aix-ppc64",
		...
		"linux-386", "linux-amd64", "linux-arm", "linux-arm64", "linux-ppc64le", "linux-mips64", "linux-mips64le", "linux-mips", "linux-mipsle", "linux-riscv64", "linux-loong64", "linux-s390x",
...
func (t *tester) internalLink() bool {
	...
	if goarch == "mips64" || goarch == "mips64le" || goarch == "mips" || goarch == "mipsle"  || goarch == "loong64" || goarch == "riscv64" {
		return false
	}
	if goos == "aix" {
